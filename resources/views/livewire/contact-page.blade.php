<main class="px-6 py-10 lg:px-8 lg:py-14">
    <section class="mx-auto max-w-7xl">
        <div class="grid gap-10 xl:grid-cols-[0.95fr_1.05fr]">
            <div class="rounded-[2rem] bg-[var(--brand-ink)] p-8 text-white shadow-2xl shadow-slate-900/15 lg:p-10">
            ...
            <div class="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-xl shadow-slate-900/5 lg:p-10">
                <div class="max-w-2xl">
                    <span class="text-xs font-semibold uppercase tracking-[0.22em] text-[var(--brand-accent)]">{{ $formSection['eyebrow'] }}</span>
                ...
                <form class="mt-8 space-y-6" wire:submit="submit">
                    <div class="grid gap-6 md:grid-cols-2">
                        <div>
                            ...
                            <input
                                ...
                                class="mt-2 w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition-colors focus:border-[var(--brand-accent)] focus:bg-white focus:ring-4 focus:ring-orange-100"
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="8"
                            class="mt-2 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition-colors focus:border-[var(--brand-accent)] focus:bg-white focus:ring-4 focus:ring-orange-100"
                    ...
                    <div class="flex flex-col gap-4 border-t border-slate-200 pt-6 md:flex-row md:items-center md:justify-end">
                        <button type="submit" class="inline-flex items-center justify-center rounded-xl bg-[var(--brand-ink)] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-slate-900/10 transition-colors hover:bg-[var(--brand-accent)]">
