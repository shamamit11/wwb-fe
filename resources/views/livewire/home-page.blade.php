        ...
        <div class="relative z-10 mx-auto w-full max-w-7xl px-6 py-20 lg:px-8">
            <div class="glass-card max-w-2xl rounded-xl p-8 shadow-2xl shadow-slate-900/20 md:p-12 lg:p-16">
                ...
                <div class="mt-8 flex flex-wrap gap-4">
                    <a href="{{ $hero['primary_cta_url'] }}" class="inline-flex rounded-xl bg-[#c2410c] px-8 py-4 text-sm font-semibold text-white shadow-lg shadow-orange-900/20 transition-all hover:-translate-y-0.5 hover:bg-[#9a3412]">
                        {{ $hero['primary_cta_label'] }}
                    </a>
                    <a href="{{ $hero['secondary_cta_url'] }}" class="inline-flex rounded-xl border-2 border-slate-200 bg-white px-8 py-4 text-sm font-semibold text-slate-900 transition-all hover:border-[#c2410c] hover:text-[#c2410c]">
    ...
    <section id="featured" class="bg-white px-6 py-16 lg:px-8">
        <div class="mx-auto max-w-7xl">
            <div class="mb-12 flex items-end justify-between gap-6 border-b border-slate-200 pb-8">
                <div class="max-w-2xl">
                    <h2 class="text-3xl font-bold tracking-tight text-slate-950 md:text-4xl">{{ $featuredSection['title'] }}</h2>
            ...
            <div class="grid gap-8 lg:grid-cols-3">
                <a href="{{ $featuredSection['lead']['href'] }}" class="group flex h-full flex-col overflow-hidden rounded-xl border border-slate-200 bg-white transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-slate-900/10 lg:col-span-2">
                    <div class="relative h-[450px] overflow-hidden">
                        <img src="{{ $featuredSection['lead']['image'] }}" alt="{{ $featuredSection['lead']['image_alt'] }}" class="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105">
                    ...
                    <div class="flex flex-1 flex-col p-8 md:p-10">
                        ...
                        <div class="mt-auto flex items-center justify-between gap-4 border-t border-slate-200 pt-6">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-sm font-medium text-slate-600">{{ $featuredSection['lead']['author'] }}</span>
                            </div>
                ...
                <div class="flex flex-col gap-8">
                    @foreach ($featuredSection['secondary'] as $item)
                        <a href="{{ $item['href'] }}" class="group flex h-full flex-col overflow-hidden rounded-xl border border-slate-200 bg-white transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-900/10">
                            <div class="h-48 overflow-hidden">
                                <img src="{{ $item['image'] }}" alt="{{ $item['image_alt'] }}" class="h-full w-full object-cover transition-transform duration-500 group-hover:scale-110">
                            </div>
                            <div class="p-6">
    ...
    <section id="guides" class="bg-slate-50 px-6 py-16 lg:px-8">
        <div class="mx-auto max-w-7xl">
            <div class="mb-12 flex flex-col gap-4 md:mb-16 md:flex-row md:items-center md:justify-between">
                <div class="max-w-2xl">
                    <h2 class="text-3xl font-bold tracking-tight text-slate-950 md:text-4xl">{{ $guideSection['title'] }}</h2>
            ...
            <div class="grid gap-8 md:grid-cols-2 xl:grid-cols-4">
                @foreach ($guideSection['items'] as $guide)
                    <a href="{{ $guide['href'] }}" class="group flex flex-col overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-slate-900/10">
                        <div class="h-48 overflow-hidden">
                            <img src="{{ $guide['image'] }}" alt="{{ $guide['image_alt'] }}" class="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105">
                        </div>
                        <div class="flex flex-1 flex-col p-6">
                            ...
                            <div class="mt-6 flex items-center justify-between gap-4 border-t border-slate-200 pt-5 text-sm text-slate-500">
    ...
    <section id="topics" class="px-6 py-16 lg:px-8">
        <div class="mx-auto max-w-7xl">
            <div class="mx-auto mb-14 max-w-3xl text-center">
                <h2 class="text-3xl font-bold tracking-tight text-slate-950 md:text-4xl">{{ $topicSection['title'] }}</h2>
        ...
        <section id="resources" class="px-6 py-6 lg:px-8">
            <div class="mx-auto max-w-7xl overflow-hidden rounded-xl bg-[#141b2b] px-8 py-12 text-white shadow-2xl shadow-slate-900/20 lg:px-12">
                <div class="grid items-center gap-12 lg:grid-cols-2">
                    <div>
                        <span class="text-sm font-semibold uppercase tracking-[0.2em] text-orange-300">{{ $promoSection['eyebrow'] }}</span>
                        <h2 class="mt-4 text-4xl font-bold tracking-tight md:text-5xl">{{ $promoSection['title'] }}</h2>
                        ...
                        <a href="{{ $promoSection['primary_cta_url'] }}" class="mt-10 inline-flex rounded-xl bg-[#c2410c] px-8 py-4 text-sm font-semibold text-white shadow-lg shadow-orange-950/30 transition-all hover:scale-[1.01] hover:bg-[#9a3412]">
    ...
    @if ($newsletterSection['enabled'])
        <section id="newsletter" class="px-6 py-16 lg:px-8">
            <div class="mx-auto max-w-3xl text-center">
                <h2 class="text-3xl font-bold tracking-tight text-slate-950 md:text-4xl">{{ $newsletterSection['title'] }}</h2>
