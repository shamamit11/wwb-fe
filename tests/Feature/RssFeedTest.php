...
class RssFeedTest extends TestCase
{
    public function test_the_rss_feed_route_returns_rss_xml_with_channel_metadata_and_items(): void
    {
        ...
        $response->assertSee('<link>https://www.widewebblog.com/best-ai-tools-seo-keyword-research-content-optimization-rank-tracking/</link>', false);
        $response->assertSee('<guid isPermaLink="true">https://www.widewebblog.com/best-ai-tools-seo-keyword-research-content-optimization-rank-tracking/</guid>', false);
