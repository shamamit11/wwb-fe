...
- `public/robots.txt` was restored as a static file with an absolute sitemap URL after the dynamic route approach proved vulnerable to stale deployed static-file precedence.
